...
| Item            | Location / detail                                                                                                                           |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| Sleep hook      | `/etc/systemd/system-sleep/50-msi-claw-s2idle-power.sh` — BT block, ZT stop, fingerprint USB unbind, gamepad rebind, battery kick, WiFi fix. Repo copy tracked at `system/system-sleep/50-msi-claw-s2idle-power.sh`. |
